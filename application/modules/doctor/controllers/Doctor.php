...
class Doctor extends CI_Controller {
    ...
    public function index($param1="",$param2="",$param3="") {
        ...
        $data['doctors'] = $this->agency->where('agency_type', 'D')->with_state()->get_all();
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($param1 == 'edit' and $param2 != "") {
                    $data['doctor'] = $this->user_agency->select_where(['agency_id' => $param2]);
                    $data['page'] = "doctor_single";
                    $data['modal_opened'] = false;
                }else{
//                    redirect(site_url('/doctor/add'), 'refresh');
                }
            }
        }
    ...
    public function doctor_single($param1,$param2="",$param3="")
    {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($param2 == 'edit') {
                    ...
                    if ( $us_agy_update >= 0 ) {
                        ...
                        redirect(site_url('doctor/' . $param1), 'refresh');
                        exit;
                    }else{
