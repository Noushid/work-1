...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo $doctor->agency_name;?></h2>
        <ol class="breadcrumb">
            <li>
            ...
            <div class="panel-heading">
                <div class="panel-options">
                    <ul class="nav nav-tabs" id="myTab">
                        ...
                        <li class="<?php echo((isset($active_tab) && $active_tab == 'doctors') ? 'active' : '');?>"><a data-toggle="tab" href="#doctors">agencies</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <div id="demographics" class="tab-pane <?php echo(!isset($active_tab) ? 'active' :  (isset($active_tab) && $active_tab == 'demographics') ? 'active' : '');?>">
                        <h3 class="text-center"><?php echo $doctor->agency_name;?></h3>
                        <div class="hr-line-solid"></div>
                        <?php echo form_open(site_url('doctor/edit/' . $doctor->agency_id), ['class' => "form-horizontal"]);?>
                            <fieldset class="the-fieldset m-t-lg">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4 <?php echo(form_error('agency_name') != '' ? 'has-error' : '');?>">
                                        <input class="form-control" type="text" name="agency_name" placeholder="Agency Name" value="<?php echo(isset($doctor) ? $doctor->agency_name : set_value('agency_name'));?>" /><!--required=""/>-->
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4 <?php echo(form_error('agency_type') != '' ? 'has-error' : '');?>">
                                        ...
                                        <select name="agency_type" class="form-control" <?php echo set_select('agency_type');?> disabled>
                                            ...
                                            <option value="A" <?php echo((isset($doctor) && $doctor->agency_type == 'A') ? 'selected' : '');
                                            echo set_select('agency_type', 'A');?>>
                                                Agency
                                            </option>
                                            <option value="C" <?php echo((isset($doctor) && $doctor->agency_type == 'C') ? 'selected' : '');
                                            echo set_select('agency_type', 'C');?>>
                                                Contractor
                                            </option>
                                            <option value="D" <?php echo((isset($doctor) && $doctor->agency_type == 'D') ? 'selected' : '');
                                    ...
                                    <div class="col-lg-4 <?php echo(form_error('agency_status') != '' ? 'has-error' : '');?>">
                                        <select name="agency_status" class="form-control" <?php echo set_select('agency_status');?> ><!--required="">-->
                                            <option value="" selected disabled>Select</option>
                                            <option value="Act" <?php echo((isset($doctor) && $doctor ->agency_status == 'Act') ? 'selected' : '');
                                            echo set_select('agency_status', 'Act');?>>Active</option>
                                            <option value="Inact" <?php echo((isset($doctor) && $doctor->agency_status == "Inact") ? 'selected' : '');
                                            echo set_select('agency_status', 'Inact');?>>Inactive</option>
                                            <option value="SA" <?php echo((isset($doctor) && $doctor  ->agency_status == 'SA') ? 'selected' : '');
                            ...
                            <fieldset class="the-fieldset m-t-lg">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4  <?php echo(form_error('address') != '' ? 'has-error' : '');?>">
                                        <textarea name="address" id="address" class="form-control"><?php echo (isset($doctor) ? $doctor->address: set_value('address'));?></textarea>
                                    </div>

                                    <label class="control-label col-lg-2">City</label>
                                    <div class="col-lg-4  <?php echo(form_error('city') != '' ? 'has-error' : '');?>">
                                        <input class="form-control" type="text" name="city" placeholder="City" value="<?php echo (isset($doctor) ? $doctor->city: set_value('city'));?>" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4  <?php echo(form_error('zipcode') != '' ? 'has-error' : '');?>">
                                        <input class="form-control" type="text" name="zipcode" placeholder="Zip code" value="<?php echo (isset($doctor) ? $doctor ->zip: set_value('zipcode'));?>" />
                                    </div>
                                </div>
                            ...
                            <fieldset class="the-fieldset m-t-lg">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4  <?php echo(form_error('contact_name') != '' ? 'has-error' : '');?>">
                                        <input class="form-control" type="text" name="contact_name" placeholder="Contact Name" value="<?php echo (isset($doctor) ? $doctor->contact_name: set_value('contact_name'));?>" /><!--required=""/>-->
                                    ...
                                    <div class="col-lg-4  <?php echo(form_error('contact_phone') != '' ? 'has-error' : '');?>">
                                        <input type="text" class="form-control" data-mask="(999) 999-9999" placeholder="Contact Phone Number" name="contact_phone" value="<?php echo (isset($doctor) ? $doctor->contact_phone: set_value('contact_phone'));?>" id="phone" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4  <?php echo(form_error('fax') != '' ? 'has-error' : '');?>">
                                        <input class="form-control" type="text" name="fax" id="fax" data-mask="99-9999999" placeholder="Fax" value="<?php echo (isset($doctor) ? $doctor  ->fax: set_value('fax'));?>" />
                                    </div>

                                    <label class="control-label col-lg-2">Email</label>
                                    <div class="col-lg-4  <?php echo(form_error('agency_email') != '' ? 'has-error' : '');?>">
                                        <input class="form-control" type="email" name="agency_email" placeholder="Email" value="<?php echo (isset($doctor) ? $doctor  ->agency_email: set_value('agency_email'));?>" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4  <?php echo(form_error('web_address') != '' ? 'has-error' : '');?>">
                                        <input class="form-control" type="text" name="web_address" placeholder="Web Address" value="<?php echo (isset($doctor) ? $doctor  ->web_address: set_value('web_address'));?>" /><!--required=""/>-->
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="the-fieldset m-t-lg">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4  <?php echo(form_error('po_box_address') != '' ? 'has-error' : '');?>">
                                        <textarea name="po_box_address" id="po_box_address" class="form-control"><?php echo (isset($doctor) ? $doctor ->po_box_address: set_value('po_box_address'));?></textarea>
                                    </div>

                                    <label class="control-label col-lg-2">City</label>
                                    <div class="col-lg-4  <?php echo(form_error('po_box_city') != '' ? 'has-error' : '');?>">
                                        <input class="form-control" type="text" name="po_box_city" placeholder="City" value="<?php echo (isset($doctor) ? $doctor ->po_box_city: set_value('po_box_city'));?>" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4  <?php echo(form_error('po_zip1') != '' ? 'has-error' : '');?>">
                                        <input class="form-control" type="text" name="po_zip1"  placeholder="Zip" value="<?php echo (isset($doctor) ? $doctor ->po_zip1: set_value('po_zip1'));?>" />
                                    </div>
                                </div>
                            </fieldset>
                            <?php
                            ...
                            <div class="ibox-content">
                                <div class="table table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTables-single-agency-user">
                                        ...
                                        <tbody>
                                        <?php
                                        if (isset($doctor ->user_agency) and $doctor->user_agency != FALSE) {
                                            foreach ($doctor  ->user_agency as $user_agency) {
                                                ?>
                                                <tr>
                    ...
                    <div id="doctors" class="tab-pane <?php echo((isset($active_tab) && $active_tab == 'doctors') ? 'active' : '');?>">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="table table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTables-doctor-agency">
                                        <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Name</th>
    ...
    <div class="modal-content animated fadeIn">
        ...
        <?php echo form_open(site_url(uri_string()), ['class' => "form-horizontal"]);?>
            ...
            <div class="modal-footer">
                ...
                <a <?php echo(isset($crnt_agy_usr) ? 'href="'.site_url('agency/' . $doctor->agency_id).'?tab=users"' : 'data-dismiss="modal"');?> class="btn btn-white">Close</a>
                <button type="submit" class="btn btn-primary">Save changes</button>
            </div>
        </form>
    </div>
