        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5 class="font-normal">Agency Name &nbsp;<span class="text-primary" style="font-size: 18px;font-weight: 600px;color: #1ab394;"> <?php echo $contractor->agency_name;?></span></h5>
                ...
                <div class="ibox-content">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs" id="contractorTab">
                    ...
                    <div class="tab-content">
                        <div id="demographics" class="tab-pane <?php echo(!isset($active_tab) ? 'active' :  (isset($active_tab) && $active_tab == 'demographics') ? 'active' : '');?>">
                            <div class="panel-body">
                                <div class="ibox float-e-margins">
                                    <div class="">
                                        <h5 class="font-normal" style="font-size: 18px;font-weight: 600px;color: #1ab394;">Edit Agency</h5>
                                    </div>
                                    <div class="ibox-content">
                                        ...
                                        <fieldset class="the-fieldset">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('agency_name') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="agency_name" value="<?php echo(isset($contractor) ? $contractor->agency_name : set_value('agency_name'));?>"/>
                                        ...
                                        <fieldset class="the-fieldset" >
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('agency_type') != '' ? 'has-error' : '');?>">
                                                    <input value="<?php echo $contractor->agency_type;?>" type="hidden" name="agency_type">
                                                    <div class="radio radio-info radio-inline">
                                                        <input disabled id="typeRadio1" value="A" type="radio" name="agency_type" <?php echo(isset($contractor) ? ($contractor->agency_type == 'A' ? 'checked' :'' ) : set_radio('agency_type', 'A')); ?>>
                                                        <label for="typeRadio1"> Agency</label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input disabled id="typeRadio2" value="C" type="radio" name="agency_type" <?php echo(isset($contractor) ? ($contractor->agency_type == 'C' ? 'checked' :'' ) : set_radio('agency_type', 'C')); ?>>
                                                        <label for="typeRadio2"> Contractor</label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline disabled">
                                                        <input disabled id="typeRadio3" value="D" type="radio" name="agency_type" <?php echo(isset($contractor) ? ($contractor->agency_type == 'D' ? 'checked' :'' ) : set_radio('agency_type', 'D')); ?>>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('agency_status') != '' ? 'has-error' : '');?>">
                                                    <div class="radio radio-info radio-inline">
                                                        <input id="statusRadio1" value="Act" type="radio" name="agency_status" <?php echo(isset($contractor) ? ($contractor->agency_status == 'Act' ? 'checked' :'' ) : set_radio('agency_status', 'Act')); ?>>
                                                        <label for="statusRadio1"> Active </label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input id="statusRadio2" value="inact" type="radio" name="agency_status" <?php echo(isset($contractor) ? ($contractor->agency_status == 'Inact' ? 'checked' :'' ) : set_radio('agency_status', 'Inact')); ?>>
                                                        <label for="statusRadio2"> Inactive </label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input id="statusRadio3" value="SA" type="radio" name="agency_status" <?php echo(isset($contractor) ? ($contractor->agency_status == 'SA' ? 'checked' :'' ) : set_radio('agency_status', 'SA')); ?>>
                                        ...
                                        <fieldset class="the-fieldset">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('address') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="address" value="<?php echo (isset($contractor) ? $contractor->address: set_value('address'));?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2 col-md-3">City</label>
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('city') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="city" value="<?php echo (isset($contractor) ? $contractor->city: set_value('city'));?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('zipcode') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="zipcode" value="<?php echo (isset($contractor) ? $contractor->zip: set_value('zipcode'));?>" />
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="the-fieldset">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('contact_name') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="contact_name" value="<?php echo (isset($contractor) ? $contractor->contact_name: set_value('contact_name'));?>"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('contact_phone') != '' ? 'has-error' : '');?>">
                                                    <input type="text" class="form-control" data-mask="(999) 999-9999" name="contact_phone" value="<?php echo (isset($contractor) ? $contractor->contact_phone: set_value('contact_phone'));?>" id="phone"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6<?php echo(form_error('fax') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="fax" id="fax" data-mask="(999) 999-9999" value="<?php echo (isset($contractor) ? $contractor->fax: set_value('fax'));?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('agency_email') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="email" name="agency_email" value="<?php echo (isset($contractor) ? $contractor->agency_email: set_value('agency_email'));?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('web_address') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="web_address" value="<?php echo (isset($contractor) ? $contractor->web_address: set_value('web_address'));?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <fieldset class="the-fieldset">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('po_box_address') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="po_box_address" value="<?php echo (isset($contractor) ? $contractor->po_box_address: set_value('po_box_address'));?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('po_box_city') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="po_box_city"  value="<?php echo (isset($contractor) ? $contractor->po_box_city: set_value('po_box_city'));?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 col-md-6 <?php echo(form_error('po_zip1') != '' ? 'has-error' : '');?>">
                                                    <input class="form-control" type="text" name="po_zip1"  value="<?php echo (isset($contractor) ? $contractor->po_zip1: set_value('po_zip1'));?>" />
                                                </div>
                                            </div>
                                        </fieldset>
                                        <?php
                                        ...
                                        <fieldset class="the-fieldset bg-muted">
                                            ...
                                            <div class="form-group">
                                                <div class="m-l-lg">
                                                    ...
                                                    <a href="<?php echo site_url('contractor')?>" class="btn btn-white">Close</a>
                                                </div>
                                            </div>
                                        </fieldset>
                                        </form>
                        ...
                        <div id="users" class="tab-pane <?php echo((isset($active_tab) && $active_tab == 'users') ? 'active' : '');?>">
                            <div class="panel-body">
                                <div class="ibox float-e-margins">
                                    <div class="">
                                        <h5 class="font-normal" style="font-size: 18px;font-weight: 600px;color: #1ab394;">Contractor user List</h5>
                                    </div>
                                    <div class="ibox-content">
                        ...
                        <div id="contractors" class="tab-pane <?php echo((isset($active_tab) && $active_tab == 'contractors') ? 'active' : '');?>">
                            <div class="panel-body">
                                <div class="ibox float-e-margins">
                                    <div class="">
                                        <h5 class="font-normal" style="font-size: 18px;font-weight: 600px;color: #1ab394;">Agency List</h5>
                                    </div>
                                    <div class="ibox-content">
                                        <div class="table table-responsive">
            ...
            <?php echo form_open(site_url(uri_string()), ['class' => "form-horizontal"]);?>
                <div class="modal-body">
                    <div
                        ...
                        <div class="col-lg-4 col-md-8 md-m-b-15">
                    ...
                    <div class="form-group " id="data_3">
                        ...
                        <div
                            class="col-lg-4 col-md-8 md-m-b-15 <?php echo(form_error('phone') != '' ? 'has-error' : ''); ?>"
                            id="data_phone">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-md-3 required">Status</label>
                        <div class="col-lg-4 col-md-8 md-m-b-15 <?php echo(form_error('status') != '' ? 'has-error' : '');?>">
                        ...
                        <div class="col-lg-4 col-md-8 md-m-b-15 <?php echo(form_error('profile') != '' ? 'has-error' : '');?>">
                            <select class="form-control" name="profile" required="" <?php set_select('profile');?>>
                                <option value="" selected disabled>Select</option>
                                <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-8 md-m-b-15 <?php echo(form_error('discipline') != '' ? 'has-error' : '');?>">
                        ...
                        <div class="col-lg-4 col-md-8 <?php echo(form_error('employee_type') != '' ? 'has-error' : '');?>">
                            <select class="form-control" name="employee_type" required="" <?php set_select('employee_type');?>>
                                <option value="" selected disabled>Select</option>
                                <?php
