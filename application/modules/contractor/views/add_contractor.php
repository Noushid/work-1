    ...
    <fieldset class="the-fieldset">
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('agency_name') != '' ? 'has-error' : '');?>">
                <input class="form-control" type="text" name="agency_name" value="<?php echo set_value('agency_name');?>" />
    ...
    <fieldset class="the-fieldset" >
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('agency_type') != '' ? 'has-error' : '');?>">
                <div class="radio radio-info radio-inline">
                    <input id="typeRadio1" value="A" type="radio" name="agency_type" <?php echo set_radio('agency_type', 'A'); ?> disabled>
                ...
                <div class="radio radio-info radio-inline disabled">
                    <input id="typeRadio3" value="D" type="radio" name="agency_type" <?php echo set_radio('agency_type', 'D'); ?> disabled checked>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('agency_status') != '' ? 'has-error' : '');?>">
                <div class="radio radio-info radio-inline">
                    <input id="statusRadio1" value="Act" type="radio" name="agency_status" <?php echo set_radio('agency_status', 'Act');?> >
                    <label for="statusRadio1"> Active </label>
                </div>
                <div class="radio radio-info radio-inline">
                    <input id="statusRadio2" value="inact" type="radio" name="agency_status" <?php echo set_radio('agency_status', 'Inact');?>>
                    <label for="statusRadio2"> Inactive </label>
                </div>
                <div class="radio radio-info radio-inline">
                    <input id="statusRadio3" value="SA" type="radio" name="agency_status" <?php echo set_radio('agency_status', 'SA');?>>
    ...
    <fieldset class="the-fieldset">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('zipcode') != '' ? 'has-error' : '');?>">
                <input class="form-control" type="text" name="zipcode" value="<?php echo set_value('zipcode');?>" />
            </div>
        </div>
    </fieldset>
    <fieldset class="the-fieldset">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('contact_name') != '' ? 'has-error' : '');?>">
                <input class="form-control" type="text" name="contact_name" value="<?php echo set_value('contact_name');?>" />
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('contact_phone') != '' ? 'has-error' : '');?>">
                <input type="text" class="form-control" data-mask="(999) 999-9999" name="contact_phone" value="<?php echo set_value('contact_phone');?>" id="phone" />
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6<?php echo(form_error('fax') != '' ? 'has-error' : '');?>">
                <input class="form-control" type="text" name="fax" id="fax" data-mask="(999) 999-9999" value="<?php echo set_value('fax');?>" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('agency_email') != '' ? 'has-error' : '');?>">
                <input class="form-control" type="email" name="agency_email" value="<?php echo set_value('agency_email');?>" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('web_address') != '' ? 'has-error' : '');?>">
                <input class="form-control" type="text" name="web_address" value="<?php echo set_value('web_address');?>" /><!--/>-->
            </div>
        </div>
        <div class="form-group">
    ...
    <fieldset class="the-fieldset">
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('po_box_address') != '' ? 'has-error' : '');?>">
                <input class="form-control" type="text" name="po_box_address" value="<?php echo set_value('po_box_address');?>" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('po_box_city') != '' ? 'has-error' : '');?>">
                <input class="form-control" type="text" name="po_box_city"  value="<?php echo set_value('po_box_city');?>" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-6 <?php echo(form_error('po_zip1') != '' ? 'has-error' : '');?>">
                <input class="form-control" type="text" name="po_zip1"  value="<?php echo set_value('po_zip1');?>" />
            </div>
        </div>
    </fieldset>
