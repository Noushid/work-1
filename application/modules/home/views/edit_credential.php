                        ...
                        <div class="modal-body">
                            <div class="form-group ">
                                    ...
                                    <select name="tab_086_credential_type" class="form-control" required="">
                                        ...
                                        if (isset($credential_types) and $credential_types != false) {
                                            foreach ($credential_types as $type) {
                                                ?>
                                                <option
                                                    value="<?php echo $type->tab_value; ?>" <?php echo (isset($credential) ? 'selected' : set_select('tab_086_credential_type', $type->tab_value));?> >
                                ...
                                <div class="col-lg-4 <?php echo(form_error('credential_id') != '' ? 'has-error' : '');?>">
                                    <input class="form-control" type="text" name="credential_id" placeholder="Credential ID" value="<?php echo(isset($credential) ? $credential->credential_id : set_value('credential_id'));?>" required=""/>
                            ...
                            <div class="form-group" id="expiration_date">
                                ...
                                <div class="col-lg-4 <?php echo(form_error('expiration_date') != '' ? 'has-error' : '');?>">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo (isset($credential) ? $credential->expiration_date : set_value('expiration_date'))?>" name="expiration_date">
                                ...
                                <div class="col-lg-4  <?php echo(form_error('alert_days') != '' ? 'has-error' : '');?>">
                                    <input class="form-control" type="text" name="alert_days" placeholder="Alert Days" value="<?php echo(isset($credential) ? $credential->alert_days : set_value('alert_days'));?>" required=""/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 <?php echo(form_error('notes') != '' ? 'has-error' : '');?>">
                                    <textarea name="notes" class="form-control"><?php echo(isset($credential) ? $credential->notes : set_value('notes'));?></textarea>
