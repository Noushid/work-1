...
*/
$config['tables']['users']           = 'us1_user';
$config['tables']['groups']          = 'xx_groups';
$config['tables']['users_groups']    = 'xx_users_groups';
$config['tables']['login_attempts']  = 'xx_login_attempts';
 ...
 */
$config['site_title']                 = "oasis.com";       // Site Title, example.com
$config['admin_email']                = "web@oasis-c1.com"; // Admin Email, admin@example.com
